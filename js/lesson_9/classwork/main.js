...
//     divBlock.classList = 'member';
//     divBlock.innerText = simpson
// }
...
//         elementBlock.innerText = `${key} - ${simpson[key]}`
//         divBlock.append(elementBlock)
//     }
//     divBlock.classList = 'member';
...
function createElementDOM(tag = 'li', innerText = '', clasList = '') {
    let block = document.createElement(tag);
    block.innerText = innerText;
...
for (const course of coursesArray) {
    ...
    for (const courseKey in course) {
        if (courseKey === 'modules') {
            let courseElement = createElementDOM(checkTag(courseKey), undefined, courseKey);
